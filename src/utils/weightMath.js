...
export function isEsgCategory(s) {
...
export const isEsgFactory = (code) => code?.startsWith('ESGF') || /^F\d/.test(code ?? '');

// Derive DB criteria_set from category code
export function getCriteriaSetFromCode(code) {
...
export function nextItemCode(sectionCode, allItems, esgFilter) {
...
export function computeEffectiveWeights(items, sectionWeight) {
...
export function computeEsgEffectiveWeights(sectionItems, totalWeight, groupWeights, esgFilter) {
...
export function getCatBuffer(pool, editedId, newVal) {
  const n = pool.length;
...
export function getItemBuffer(sec, editedId, newVal) {
...
export function getEsgItemBuffer(pool, totalWeight, groupWeights, editedId, newVal) {
...
export function scaleItemsToTotal(secItems, newTotal, forceEqual = false) {
...
export function scaleSectionItemsToTotal(sec, newTotal, forceEqual = false) {
