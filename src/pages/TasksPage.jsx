...
export default function TasksPage({ onBack, onUploadHistory }) {
  ...
  useEffect(() => { setPage(1); setSelected(new Set()); }, [mainTab, statusFilter, typeFilter, search, dateFrom, dateTo, sortDir]);
  ...
  }, [baseList, mainTab, statusFilter, typeFilter, search, dateFrom, dateTo, sortDir]);
