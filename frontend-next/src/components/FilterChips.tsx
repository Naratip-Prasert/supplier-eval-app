// ============================================================
//  components/FilterChips.tsx — multi-select pill filter, shared
...
export function FilterChips<T>({ options, selected, onToggle, onClear, activeColor = "#1b5e20", activeBg }: FilterChipsProps<T>) {
