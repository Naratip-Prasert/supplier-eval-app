// ============================================================
//  utils/dateFilter.tsx — shared "date range or quick preset" filter
...
export function todayRangeFilter(): DateFilter {
  const t = todayStr();
...
export function DateFilterBar({ filter, onChange, label = "ช่วงวันที่", showPresets = true }: DateFilterBarProps) {
