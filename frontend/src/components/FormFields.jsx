...
export function ReadBox({ value, placeholder, locked }) {
  return (
    <div style={{
...
// ── Text input ────────────────────────────────────────────────
export function TextInput({ value, onChange, onBlur, placeholder, themeColor }) {
...
export function StyledSelect({ value, onChange, options, placeholder, themeColor }) {
  const [focused, setFocused] = useState(false);
  return (
