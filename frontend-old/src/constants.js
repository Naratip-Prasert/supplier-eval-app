...
export const PRE_CRITERIA     = criteriaData.PRE_CRITERIA;
export const POST_CRITERIA    = criteriaData.POST_CRITERIA;
export const FUNCTION_MODULES = criteriaData.FUNCTION_MODULES;
