...
async function fixSchema() {
  ...
  try {
    ...
    await client.query(`ALTER TABLE "SPES_evaluation_sessions" ALTER COLUMN initiated_by TYPE text USING initiated_by::text;`);
    await client.query(`ALTER TABLE "SPES_evaluations" ALTER COLUMN employee_id TYPE text USING employee_id::text;`);
